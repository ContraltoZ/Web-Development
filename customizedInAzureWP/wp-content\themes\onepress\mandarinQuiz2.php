<?php /* Template Name: MandarinMistakeQuiz2 */ ?>
<?php
/**
...
<div id="content" class="site-content quiz-content">
    ...
    $sql = "SELECT questionDetail, option1, option2, option3, option4 FROM QUIZQUESTION WHERE nationality='Mandarin' AND quizID=2";
    ...
    <form method="post" action="../quizresult?quizID=2&nationality=Mandarin">
                ...
                <ul id="issues">                        
                    ...
                    <li id="Q7">
                        ...
                        <h4><label style="margin:5px;"><input type="radio" name="question7" value="A">
                            ...
                            <?php print_r($quiz[6]["option2"]); ?></label>
                        </h4>
                    </li>
                    <li id="Q8">
                        <h1>Question 8</h1>
