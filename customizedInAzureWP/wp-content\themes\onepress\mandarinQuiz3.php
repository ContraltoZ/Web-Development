<?php /* Template Name: MandarinMistakeQuiz3 */ ?>
<?php
/**
...
<div id="content" class="site-content quiz-content">
    ...
    $sql = "SELECT questionDetail, option1, option2, option3, option4 FROM QUIZQUESTION WHERE nationality='Mandarin' AND quizID=3";
    ...
    <form method="post" action="../quizresult?quizID=3&nationality=Mandarin">
                ...
                <ul id="issues">                        
                    <li id="Q1">
                        ...
                        <h4><label style="margin:5px;"><input type="radio" name="question1" value="A">
                            ...
                            <?php print_r($quiz[0]["option2"]); ?></label>
                        </h4>
                    </li>
                    <li id="Q2">
                        <h1>Question 2</h1>
                    ...
                    <li id="Q5">
                        ...
                        <h4><label style="margin:5px;"><input type="radio" name="question5" value="A">
                            ...
                            <?php print_r($quiz[4]["option2"]); ?></label>
                        </h4>
                    </li>
                    <li id="Q6">
                        <h1>Question 6</h1>
