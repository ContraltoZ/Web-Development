<?php /* Template Name: GermanMistakeQuiz1 */ ?>
<?php
/**
...
<div id="content" class="site-content quiz-content">
    ...
    $sql = "SELECT questionDetail, option1, option2, option3, option4 FROM QUIZQUESTION WHERE nationality='German' AND quizID=1";
    ...
    <form method="post" action="../quizresult?quizID=1&nationality=German">
                ...
                <ul id="issues">                        
                    ...
                    <li id="Q3">
                        ...
                        <h4><label style="margin:5px;"><input type="radio" name="question3" value="A">
                            ...
                            <?php print_r($quiz[2]["option2"]); ?></label>
                        </h4>
                    </li>
                    <li id="Q4">
                        <h1>Question 4</h1>
