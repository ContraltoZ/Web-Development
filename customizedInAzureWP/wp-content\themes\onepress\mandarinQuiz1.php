<?php /* Template Name: MandarinMistakeQuiz1 */ ?>
<?php
/**
...
<div id="content" class="site-content quiz-content">
    ...
    $sql = "SELECT questionDetail, option1, option2, option3, option4 FROM QUIZQUESTION WHERE nationality='Mandarin' AND quizID=1";
    ...
    <form method="post" action="../quizresult?quizID=1&nationality=Mandarin">
            ...
            <div id="timeline">
                ...
                <ul id="issues">                        
                    ...
                    <li id="Q4">
                            ...
                            <h4><label style="margin:5px;"><input type="radio" name="question4" value="A">
                    ...
                    <li id="Q6">
                            ...
                            <h4><label style="margin:5px;"><input type="radio" name="question6" value="A">
                                ...
                                <?php print_r($quiz[5]["option2"]); ?></label><br/>
                                <label style="margin:5px;"><input type="radio" name="question6" value="C">
                                <?php print_r($quiz[5]["option3"]); ?></label><br/>
                                <label style="margin:5px;"><input type="radio" name="question6" value="D" >
                                <?php print_r($quiz[5]["option4"]); ?></label>
                            </h4>
                        </li>
                    <li id="Q7">
                        <h1>Question 7</h1>
                    ...
                    <li id="Q8">
                        ...
                        <h4><label style="margin:5px;"><input type="radio" name="question8" value="A">
                            ...
                            <?php print_r($quiz[7]["option2"]); ?></label><br/>
                            <label style="margin:5px;"><input type="radio" name="question8" value="C" >
                            <?php print_r($quiz[7]["option3"]); ?></label><br/>
                            <label style="margin:5px;"><input type="radio" name="question8" value="D">
                            <?php print_r($quiz[7]["option4"]); ?></label>
                        </h4>
                    </li>
                    <li id="Q9">
                        <h1>Question 9</h1>
